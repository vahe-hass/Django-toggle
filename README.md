# [Django-toggle Dashboard](https://github.com/vahe-hass/Django-toggle/) Django

Open-source **Django Dashboard** generated by `AppSeed` op top of a modern design. Designed for those who like bold elements and beautiful websites, **[Django-toggle Dashboard](https://github.com/vahe-hass/Django-toggle/)** Enables the end-user(Your Client) to toggle requested services to an active or inactive state and let the service provider(You) know whether they want to continue receiving a particular service or not.

<br />

> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-01 10:05`

- 👉 [Soft UI Dashboard Django](https://appseed.us/product/soft-ui-dashboard/django/) - Product page
- 👉 [Django-toggle Dashboard](https://django-toggle.herokuapp.com/) - LIVE Demo
...
```bash
$ # Get the code
$ git clone https://github.com/vahe-hass/Django-toggle.git
$ cd Django-toggle
```
